...
def docker_api(method: str, path: str, json_body: dict | None = None,
               params: dict | None = None, timeout: float = 10.0, parse_json: bool = True):
    ...
    httpx-gebaseerde stijl van dit project). parse_json=False voor endpoints
    die platte tekst teruggeven (bv. /containers/{id}/logs)."""
