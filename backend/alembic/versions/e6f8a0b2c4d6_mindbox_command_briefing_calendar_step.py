"""mindbox_commands update: Briefing (item 1120) - Bart, 8-9-2026: sluit de
Kalender (item 1117) aan op de dagelijkse Briefing, zodat aankomende
deadlines ook zonder een vers document die dag proactief in de briefing
verschijnen. Voegt een ListDeadlines-stap toe en breidt de synthese-
instructie uit met een subsectie voor aankomende/verlopen datums.
...
def downgrade() -> None:
    # Downgrade is geen exacte inverse (de vorige 5-stappen-versie zelf was
    # ook al een tussenstap) - zet terug naar de laatst bekende 5-stappen-
    # vorm van vlak voor deze migratie.
    OLD_STEPS = [
        {"kind": "api_call", "action_key": "RunAll",
         "instruction": "Download alle openstaande items en briefing.md",
         "cli_hint": "-Run -All -Env {env}"},
