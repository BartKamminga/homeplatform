...
import { getTimeline, createEntry, deleteEntry } from '../api.js'
...
export default function TimelineAdmin() {
  ...
  const [form, setForm] = useState({ kind: 'oefen', title: '', date: '', opponent: '' })
  ...
  async function add() {
    ...
    try {
      ...
      setForm({ kind: 'oefen', title: '', date: '', opponent: '' })
      load()
    } catch (e) {
      setError(e.message)
    }
