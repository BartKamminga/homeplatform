...
export const SCAN_PLAN_GROUPS = [
  {
    ...
    fields: [
      ...
      { key: 'live_check_window_min', label: 'Live-check-venster (min)',
      ...
      { key: 'end_check_cadence_min', label: 'Eind-check-basis-cadans (min)',
