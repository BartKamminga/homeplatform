...
// Debug-pagina voor de echte vanger-queue (Bart: "obv selecties de queue
// kunnen doorlopen") - los van de Scout-tab (die toont alleen de laatste 200,
// ongefilterd). Puur lezend: browse filtert/pagineert de echte VangerCmd-
// rijen, "preview volgende" simuleert GET /vanger/cmd-queue/next (welke cmd
// Ghost/Scout nu zou oppakken) zonder de queue te muteren.
