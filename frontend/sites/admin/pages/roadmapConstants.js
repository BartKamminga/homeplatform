...
export const SITES = ["alle", "platform", "landing", "admin", "account", "dontforget", "mixmusic", "nkhockey", "tournix", "fiets", "poulebord", "beatcrades", "scrapster", "hockey-inside", "agent-control", "mindbox"];
