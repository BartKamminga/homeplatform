...
function DataStorageLink() {
  return (
    <Card title="Data &amp; instellingen" icon="◈">
      <p style={{ fontSize: '13px', color: 'var(--color-text-muted)', lineHeight: 1.5, marginBottom: '14px' }}>
        Overzicht van wat per gebruiker, groep of apparaat wordt opgeslagen.
        Inclusief live rij-tellingen per tabel.
      </p>
      <a href="/admin/data-storage" style={{
        display: 'inline-flex', alignItems: 'center', gap: '6px',
        fontSize: '13px', color: 'var(--color-primary)', textDecoration: 'none', fontWeight: 500,
      }}>
        Openen →
      </a>
    </Card>
