...
const LS_ROWS = [
  ...
  { label: 'mm_desktop_layout',                  note: 'Desktop layout — cache (via DB)',                 scope: 'MixMusic' },
  { label: 'mm_mobile_layout',                   note: 'Mobiel layout — cache (via DB)',                  scope: 'MixMusic' },
  ...
  { label: 'mm_resume', note: 'Laatste track + positie voor hervatten', scope: 'MixMusic' },
