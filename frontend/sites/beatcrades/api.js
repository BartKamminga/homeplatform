...
export const mergeSections   = (source_id, target_id) => api.post('/api/beatcrades/sections/merge', { source_id, target_id })
export const mergeRacks      = (source_id, target_id) => api.post('/api/beatcrades/racks/merge',    { source_id, target_id })
