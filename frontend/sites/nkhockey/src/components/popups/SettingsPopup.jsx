...
export default function SettingsPopup({ onClose, showForm, setShowForm, saveForm, showPlayed, setShowPlayed, savePlayed, showMatches, setShowMatches, saveMatches, simCount, setSimCount, saveSimCount, focusMode, setFocusMode, focusClub, setFocusClub, allClubs }) {
  return (
